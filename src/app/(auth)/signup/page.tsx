  ...
  return (
    ...
    >
      ...
      <motion.div variants={fadeUp} className="text-center mb-6">
        ...
        >
          <span
            className="bg-gradient-to-r from-green-400 to-emerald-500 text-white text-xs font-bold px-4 py-1.5 rounded-full"
            style={{
        ...
        <p className="text-white/80 font-medium">
          Start building gamified forms for free
        </p>
      </motion.div>
      ...
      >
        ...
        <div
          className="bg-gradient-to-r from-green-400 via-emerald-500 to-cyan-500 px-6 py-3 flex items-center justify-between"
        ...
        <div className="p-6 sm:p-8">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <motion.div variants={fadeUp} className="pt-1">
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-gradient-to-r from-green-400 to-emerald-500 text-white font-bold py-3 px-6 rounded-xl text-base transition-all hover:shadow-lg active:translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed"
                style={{
          ...
          <motion.p variants={fadeUp} className="mt-6 text-center text-sm text-gray-500">
            ...
            <Link href="/login" className="text-purple-500 hover:text-purple-600 font-bold hover:underline">
              Sign in
            </Link>
          </motion.p>
        </div>
